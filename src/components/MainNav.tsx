...
export function MainNav() {
  ...
  return <div className="flex items-center justify-between px-6 py-4">
      ...
      <div className="flex items-center gap-4">
        {isLoading ? <Button variant="outline" className="rounded-full px-4 py-2 border-primary/20 bg-primary/5 hover:bg-primary/10 transition-all" disabled>
            Loading...
          </Button> : user ? <>
            <Link to="/dashboard">
            ...
            <Button variant="outline" className="rounded-full px-4 py-2 border-primary/20 bg-primary/5 hover:bg-primary/10 transition-all" onClick={() => signOut()}>
